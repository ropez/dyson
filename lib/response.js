...
var setValues = function(template, params, scope) {
    ...
    var deferred = when.defer(),
        promises = [],
        obj = _.isArray(template) ? [] : {};

    scope = scope || Object.create(template);

    _.each(template, function(value, key) {

        obj[key] = _.isFunction(value) ? value.apply(scope, params) : _.isPlainObject(value) ? setValues(value, params, scope) : value;
